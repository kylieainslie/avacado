...
# This script runs simulations for Wave 3
...
# read in results from Wave 2
scenarioA_wave2 <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave2_scenarioA.rds")
scenarioB_wave2 <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave2_scenarioB.rds")
scenarioC_wave2 <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave2_scenarioC.rds")
scenarioD_wave2 <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave2_scenarioD.rds")
scenarioE_wave2 <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave2_scenarioE.rds")

# get tail of dataset for each simulation
initA <- lapply(scenarioA_wave2, tail, 1)
initB <- lapply(scenarioB_wave2, tail, 1)
initC <- lapply(scenarioC_wave2, tail, 1)
initD <- lapply(scenarioD_wave2, tail, 1)
...
params <- list(N = n_vec,  # population size
               ...
               alpha = c(0.03, 0.56, 0.69, 0.71, 0.80, 0.86, 0.89, 0.93, 0.93),
               t_vac_start = t_start,
               t_vac_end = t_start + 1,
...
saveRDS(scenarioA, "/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioA.rds")
...
saveRDS(scenarioB, "/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioB.rds")
doParallel::stopImplicitCluster()
...
saveRDS(scenarioC, "/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioC.rds")
doParallel::stopImplicitCluster()
...
saveRDS(scenarioD, "/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioD.rds")
doParallel::stopImplicitCluster()
...
saveRDS(scenarioE, "/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioE.rds")
doParallel::stopImplicitCluster()
...
scenarioA <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioA.rds")
scenarioB <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioB.rds")
scenarioC <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioC.rds")
scenarioD <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioD.rds")
scenarioE <- readRDS("/rivm/s/ainsliek/results/covid_scenarios/wave3_scenarioE.rds")
